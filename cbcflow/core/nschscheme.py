...
class NSCHScheme(Parameterized):
    """Base class for all Navier-Stokes/Cahn-Hilliard schemes."""
    ...
    def default_params(cls):
        params = ParamDict(
            ...
            c_degree = None, # Require this to be set explicitly by scheme subclass!
            mu_degree = None, # Require this to be set explicitly by scheme subclass!
            ...
            # TODO check usage of `solver_c`
            solver_c=None, # overrides neumann/dirichlet if given
    ...
    def solve(self, problem, timer):
        """Solve Navier-Stokes/Cahn-Hilliard problem by executing scheme."""
